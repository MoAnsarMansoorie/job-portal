    ...
    <div>
      ...
      <div className="flex items-center justify-center max-w-7xl mx-auto">
        <form onSubmit={submitHandler} className="w-1/2 border border-gray-300 rounded p-4 my-10">
          ...
          {
            loading ? <Button className="w-full my-2"> <Loader2 className="mr-2 h-4 w-4 animate-spin">Please Wait</Loader2> </Button> : <Button type="submit" className="w-full my-2">Login</Button>
          }
